...
local Namebot = (Redis:get(BEST.."Name:Bot") or "بيست")
local BotName = {
...
{
{text = 'مبرمج السورس',type = 'text'},{text = 'مطور السورس',type = 'text'},
},
{
...
if text == 'مبرمج السورس' or text == ' المبرمج' then  
local UserId_Info = LuaTele.searchPublicChat("QQWGT")
if UserId_Info.id then
local  ban = LuaTele.getUser(UserId_Info.id)
local  bain = LuaTele.getUserFullInfo(Sudo_Id)
...
if text == 'المبرمج معتز' or text == 'زوز' or text == 'ميزو' or text == 'معتز' then  
local UserId_Info = LuaTele.searchPublicChat("QQWGT")
if UserId_Info.id then
local  ban = LuaTele.getUser(UserId_Info.id)
local  bain = LuaTele.getUserFullInfo(Sudo_Id)
