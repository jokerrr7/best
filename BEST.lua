...
Redis:set(BEST..'GetTexting:DevBEST'..msg_chat_id..':'..msg.sender.user_id,true)
...
local inget = Redis:get(BEST..'hmsabots'..ramsesadd[3]..data.sender_user_id)
...
Redis:set(BEST..'hmsabots'..idnum..UserId_Info.id,username[1])
Redis:set(BEST..'hmsabots'..idnum..data.sender_user_id,username[1])
end
end
end
