...
Redis:set(best.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تك','تنزيل الكل')
...
Redis:set(best.."Get:Reides:Commands:Group"..msg_chat_id..":"..'سح','مسح سحكاتي')
Redis:set(best.."Get:Reides:Commands:Group"..msg_chat_id..":"..'غ','غنيلي')
Redis:set(best.."Get:Reides:Commands:Group"..msg_chat_id..":"..'رس','رسائلي')
