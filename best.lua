...
photo = "https://t.me/BLACK_TEAM_4/2565"
local T =[[
...
keyboard.inline_keyboard = {
{
{text = '‹ Dev source › ', url = "https://t.me/QQWGT"},
},
{
{text = '‹ 𝑺𝑶𝑼𝑹𝑪𝑬 𝑩𝑬𝑺𝑻 ›', url = "https://t.me/QQWGT2"}
},
...
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/'..Redis:get(itsblack..'black:Channel:Join')}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n᥀︙عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
end
Redis:set(itsblack.."black:Get:Reides:Commands:Group"..msg_chat_id..":"..'تعط','تعطيل الايدي بالصوره')
Redis:set(itsblack.."black:Get:Reides:Commands:Group"..msg_chat_id..":"..'تفع','تفعيل الايدي بالصوره')
Redis:set(itsblack.."black:Get:Reides:Commands:Group"..msg_chat_id..":"..'ا','ايدي')
Redis:set(itsblack.."black:Get:Reides:Commands:Group"..msg_chat_id..":"..'م','رفع مميز')
Redis:set(itsblack.."black:Get:Reides:Commands:Group"..msg_chat_id..":"..'اد', 'رفع ادمن')
Redis:set(itsblack.."black:Get:Reides:Commands:Group"..msg_chat_id..":"..'مد','رفع مدير')
Redis:set(itsblack.."black:Get:Reides:Commands:Group"..msg_chat_id..":"..'من', 'رفع منشئ')
Redis:set(itsblack.."black:Get:Reides:Commands:Group"..msg_chat_id..":"..'اس', 'رفع منشئ اساسي')
Redis:set(itsblack.."black:Get:Reides:Commands:Group"..msg_chat_id..":"..'مط','رفع مطور')
Redis:set(itsblack.."black:Get:Reides:Commands:Group"..msg_chat_id..":"..'تك','تنزيل الكل')
Redis:set(itsblack.."black:Get:Reides:Commands:Group"..msg_chat_id..":"..'ر','الرابط')
Redis:set(itsblack.."black:Get:Reides:Commands:Group"..msg_chat_id..":"..'رر','ردود المدير')
Redis:set(itsblack.."black:Get:Reides:Commands:Group"..msg_chat_id..":"..'ك','مسح المكتومين')
Redis:set(itsblack.."black:Get:Reides:Commands:Group"..msg_chat_id..":"..'رد','اضف رد')
Redis:set(itsblack.."black:Get:Reides:Commands:Group"..msg_chat_id..":"..'سح','مسح سحكاتي')
Redis:set(itsblack.."black:Get:Reides:Commands:Group"..msg_chat_id..":"..'غ','غنيلي')
Redis:set(itsblack.."black:Get:Reides:Commands:Group"..msg_chat_id..":"..'رس','رسائلي')
Redis:set(itsblack.."black:Get:Reides:Commands:Group"..msg_chat_id..":"..'ثانوي','رفع مطور ثانوي')
