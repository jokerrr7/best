...
photo = "https://t.me/bestPhotoo/2"
local T =[[
Welcome To Source\n᥀︙[Source best](https://t.me/QQWGT2) .]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '᥀ Source Channel', url = "https://t.me/QQWGT2"},
},
{
{text = '᥀ Developer', url = "https://t.me/QQWGT"}
},
}
...
if text == (Redis:get(Thebest.."best:Name:Bot") or "لار") then
local NamesBot = (Redis:get(Thebest.."best:Name:Bot") or "لار")
local NameBots = {
"عمر "..NamesBot.. " شتريد؟",
"أჂ̤ أჂ̤ هياتني اني",
"موجود بس لتصيح",
...
local CmdStart = '*\n᥀︙أهلآ بك في بوت '..(Redis:get(Thebest.."best:Name:Bot") or "لار")..
