...
download('https://raw.githubusercontent.com/DevQQWGT2/best/master/best.lua','best.lua')
...
keyboard.inline_keyboard = {
{
{text = '‹ Dev source › ', url = "https://t.me/QQWGT"},{text = '‹ ِDev source ›', url = "https://t.me/Asma_2t"}
},
{
{text = '‹ 𝑺𝑶𝑼𝑹𝑪𝑬 𝑩𝑬𝑺𝑻 ›', url = "https://t.me/QQWGT2"}
},
...
Redis:set(Thebest.."best:Get:Reides:Commands:Group"..msg_chat_id..":"..'تعط','تعطيل الايدي بالصوره')
Redis:set(Thebest.."best:Get:Reides:Commands:Group"..msg_chat_id..":"..'تفع','تفعيل الايدي بالصوره')
Redis:set(Thebest.."best:Get:Reides:Commands:Group"..msg_chat_id..":"..'ا','ايدي')
Redis:set(Thebest.."best:Get:Reides:Commands:Group"..msg_chat_id..":"..'م','رفع مميز')
Redis:set(Thebest.."best:Get:Reides:Commands:Group"..msg_chat_id..":"..'اد', 'رفع ادمن')
Redis:set(Thebest.."best:Get:Reides:Commands:Group"..msg_chat_id..":"..'مد','رفع مدير')
Redis:set(Thebest.."best:Get:Reides:Commands:Group"..msg_chat_id..":"..'من', 'رفع منشئ')
Redis:set(Thebest.."best:Get:Reides:Commands:Group"..msg_chat_id..":"..'اس', 'رفع منشئ اساسي')
Redis:set(Thebest.."best:Get:Reides:Commands:Group"..msg_chat_id..":"..'مط','رفع مطور')
Redis:set(Thebest.."best:Get:Reides:Commands:Group"..msg_chat_id..":"..'تك','تنزيل الكل')
Redis:set(Thebest.."best:Get:Reides:Commands:Group"..msg_chat_id..":"..'ر','الرابط')
Redis:set(Thebest.."best:Get:Reides:Commands:Group"..msg_chat_id..":"..'رر','ردود المدير')
Redis:set(Thebest.."best:Get:Reides:Commands:Group"..msg_chat_id..":"..'،،','مسح المكتومين')
Redis:set(Thebest.."best:Get:Reides:Commands:Group"..msg_chat_id..":"..'رد','اضف رد')
Redis:set(Thebest.."best:Get:Reides:Commands:Group"..msg_chat_id..":"..'سح','مسح سحكاتي')
Redis:set(Thebest.."best:Get:Reides:Commands:Group"..msg_chat_id..":"..'غ','غنيلي')
Redis:set(Thebest.."best:Get:Reides:Commands:Group"..msg_chat_id..":"..'رس','رسائلي')
Redis:set(Thebest.."best:Get:Reides:Commands:Group"..msg_chat_id..":"..'ثانوي','رفع مطور ثانوي')
return LuaTele.sendText(msg_chat_id,msg_id,[[*
