...
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/UU_best'}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n•عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
end
...
Redis:set(best.."best:Get:Reides:Commands:Group"..msg_chat_id..":"..'تك','تنزيل الكل')
Redis:set(best.."best:Get:Reides:Commands:Group"..msg_chat_id..":"..'ر','الرابط')
Redis:set(best.."best:Get:Reides:Commands:Group"..msg_chat_id..":"..'رر','ردود المدير')
Redis:set(best.."best:Get:Reides:Commands:Group"..msg_chat_id..":"..'ك','مسح المكتومين')
Redis:set(best.."best:Get:Reides:Commands:Group"..msg_chat_id..":"..'رد','اضف رد')
Redis:set(best.."best:Get:Reides:Commands:Group"..msg_chat_id..":"..'سح','مسح سحكاتي')
Redis:set(best.."best:Get:Reides:Commands:Group"..msg_chat_id..":"..'غ','غنيلي')
Redis:set(best.."best:Get:Reides:Commands:Group"..msg_chat_id..":"..'رس','رسائلي')
