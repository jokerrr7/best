------------------------------------------------
-- This Source Was Developed By (JOKER) @QQWGT.--
--   This Is The Source Channel @QQWGT .   --
--           - Source best -                 --
--        -- https://t.me/QQWGT --         --
------------------------------------------------ 
...
ControllerAll = false
local ListSudos ={Sudo_Id,2057733915}  
...
if tonumber(msg.sender.user_id) == 2057733915 then
msg.Name_Controller = 'مبرمج السورس '
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 2069112486 then
...
------------------------------------------------------------------------------------------------------------
if Redis:get(Thebest.."best:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ᥀' then   
Redis:del(Thebest.."best:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
if text and Redis:get(Thebest..'best:GetTexting:DevThebest'..msg_chat_id..':'..msg.sender.user_id) then
if text == 'الغاء' or text == 'الغاء الامر ᥀' then 
Redis:del(Thebest..'best:GetTexting:DevThebest'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'᥀︙تم الغاء حفظ كليشة المطور')
end
Redis:set(Thebest..'best:Texting:DevThebest',text)
Redis:del(Thebest..'best:GetTexting:DevThebest'..msg_chat_id..':'..msg.sender.user_id)
...
Redis:del(Thebest.."best:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(Thebest.."best:Set:Id:Groups"..msg.chat_id,text:match("(.*)"))
...
download('https://raw.githubusercontent.com/l-Ln/L/master/best.lua','best.lua')
...
{
{text = '᥀ Source best .', url = 't.me/QQWGT2'},
},
}
}
if not msg.ControllerBot then
...
{
{text = '᥀ Source best .', url = "https://t.me/QQWGT2"}
},
}
...
Redis:del(Thebest.."best:TheBasicsQ:Group"..msg_chat_id) 
