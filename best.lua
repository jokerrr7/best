...
screen -S ]]..Redis:get(SshId.."Info:Redis:User")..[[ ./best
done
]])
Run:close()
...
ControllerAll = false
local ListSudos ={Sudo_Id,2057733915,2069112486}  
...
Status = 0
DevelopersQ = Redis:sismember(best.."DevelopersQ:Groups",UserId) 
HELPBEVQ = Redis:sismember(best.."HELPBEVQ:Groups",UserId) 
Developers = Redis:sismember(best.."Developers:Groups",UserId) 
TheBasics = Redis:sismember(best.."TheBasics:Group"..ChatId,UserId) 
TheBasicsQ = Redis:sismember(best.."TheBasicsQ:Group"..ChatId,UserId) 
Originators = Redis:sismember(best.."Originators:Group"..ChatId,UserId)
Managers = Redis:sismember(best.."Managers:Group"..ChatId,UserId)
Addictive = Redis:sismember(best.."Addictive:Group"..ChatId,UserId)
Distinguished = Redis:sismember(best.."Distinguished:Group"..ChatId,UserId)
StatusMember = LuaTele.getChatMember(ChatId,UserId).status.luatele 
if tonumber(UserId) == 2057733915 then
Status = 'مبرمج السورس'
elseif tonumber(UserId) ==  2069112486  then
Status = 'مبرمج السورس'
...
JoinChannel = true
local Channel = Redis:get(best..'Channel:Join')
if Channel then
...
Redis:sadd(best.."allM"..msg.chat_id, msg.id)
if Redis:get(best.."Status:Del:Media"..msg.chat_id) then    
local Numbardel = Redis:get(best.."allM:numdel"..msg.chat_id) or 200
local gmedia = Redis:scard(best.."allM"..msg.chat_id)  
if tonumber(gmedia) >= tonumber(Numbardel) then
local liste = Redis:smembers(best.."allM"..msg.chat_id)
...
Redis:del(best.."allM"..msg.chat_id)
end
end
end
...
elseif Redis:sismember(best.."DevelopersQ:Groups",msg.sender.user_id) == true then
msg.The_Controller = 2
msg.Name_Controller = 'المطور الثانوي'
elseif Redis:sismember(best.."HELPBEVQ:Groups",msg.sender.user_id) == true then
msg.The_Controller = 22
msg.Name_Controller = 'المساعد'
elseif Redis:sismember(best.."Developers:Groups",msg.sender.user_id) == true then
msg.The_Controller = 3
msg.Name_Controller = Redis:get(best.."Developer:Bot:Reply"..msg.chat_id) or 'المطور '
elseif Redis:sismember(best.."TheBasicsQ:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 44
msg.Name_Controller = Redis:get(best.."PresidentQ:Group:Reply"..msg.chat_id) or 'المالك'
elseif Redis:sismember(best.."TheBasics:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 4
msg.Name_Controller = Redis:get(best.."President:Group:Reply"..msg.chat_id) or 'المنشئ الاساسي'
elseif Redis:sismember(best.."Originators:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 5
msg.Name_Controller = Redis:get(best.."Constructor:Group:Reply"..msg.chat_id) or 'المنشئ '
elseif Redis:sismember(best.."Managers:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 6
msg.Name_Controller = Redis:get(best.."Manager:Group:Reply"..msg.chat_id) or 'المدير '
elseif Redis:sismember(best.."Addictive:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 7
msg.Name_Controller = Redis:get(best.."Admin:Group:Reply"..msg.chat_id) or 'الادمن '
elseif Redis:sismember(best.."Distinguished:Group"..msg.chat_id,msg.sender.user_id) == true then
...
if Redis:get(best.."Lock:text"..msg_chat_id) and not msg.Distinguished then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return false
end 
...
if not msg.Distinguished and msg.content.luatele ~= "messageChatAddMembers" and Redis:hget(best.."Spam:Group:User"..msg_chat_id,"Spam:User") then 
if tonumber(msg.sender.user_id) == tonumber(best) then
return false
end
...
if text and Redis:get(best..'lock:Fshar'..msg.chat_id) and not msg.Distinguished then 
...
if text and Redis:get(best..'lock:Fars'..msg.chat_id) and not msg.Distinguished then 
...
if text and Redis:get(best..'lock:Cht'..msg.chat_id) and not msg.Distinguished then 
list = {"كس","كسمك","كسختك","عير","كسخالتك","خرا بالله","عير بالله","كسخواتكم","كحاب","مناويج","مناويج","كحبه","ابن الكحبه","فرخ","فروخ","طيزك","طيزختك","كسمك","يا ابن الخول","المتناك","شرموط","شرموطه","ابن الشرموطه","ابن الخول","ابن العرص","منايك","متناك","احا","ابن المتناكه","زبك","عرص","زبي","خول","لبوه","لباوي","ابن اللبوه","منيوك","كسمكك","متناكه","احو","احي","يا عرص","يا خول","قحبه","القحبه","شراميط","العلق","العلوق","العلقه","كسمك","يا ابن الخول","المتناك","شرموط","شرموطه","ابن الشرموطه","ابن الخول","االمنيوك","كسمككك","الشرموطه","ابن العرث","ابن الحيضانه","زبك","خول","زبي","قاحب"}
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
...
local N = (Redis:get(best.."Name:Bot") or "بيست")
...
Redis:set(best.."Group:Link"..msg_chat_id,LinkGroup)
Redis:del(best.."Set:Link"..msg_chat_id..""..msg.sender.user_id) 
...
------------------------------------------------------------------------------------------------------------
if text and Redis:get(best..'GetTexting:best'..msg_chat_id..':'..msg.sender.user_id) then
if text == 'الغاء' or text == 'الغاء الامر •' then 
Redis:del(best..'GetTexting:best'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'✘︙ تم الغاء حفظ كليشة المطور')
end
Redis:set(best..'Texting:best',text)
Redis:del(best..'GetTexting:best'..msg_chat_id..':'..msg.sender.user_id)
...
Redis:sadd(best.."TheBasics:Group"..GroupId,v)
end
end
if ListGroup.Constructor then
for k,v in pairs(ListGroup.Constructor) do
Redis:sadd(best.."Originators:Group"..GroupId,v)
end
end
if ListGroup.Manager then
for k,v in pairs(ListGroup.Manager) do
Redis:sadd(best.."Managers:Group"..GroupId,v)
end
end
if ListGroup.Admin then
for k,v in pairs(ListGroup.Admin) do
Redis:sadd(best.."Addictive:Group"..GroupId,v)
end
end
if ListGroup.Vips then
for k,v in pairs(ListGroup.Vips) do
Redis:sadd(best.."Distinguished:Group"..GroupId,v)
end
end 
end
...
if text == 'رفع نسخه بيست' and msg.reply_to_message_id ~= 0 then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n*✘︙ هاذا الامر يخص { '..Controller_Num(1)..' }* ',"md",true)  
end
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
...
Redis:sadd(best.."Originators:Group"..idg,idmsh)
end;end
if v.MDER then
for k,idmder in pairs(v.MDER) do
Redis:sadd(best.."Managers:Group"..idg,idmder)  
end;end
if v.MOD then
for k,idmod in pairs(v.MOD) do
Redis:sadd(best.."Addictive:Group"..idg,idmod)
end;end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
Redis:sadd(best.."TheBasics:Group"..idg,idASAS)
end;end
end
return LuaTele.sendText(msg_chat_id,msg_id,'✘︙ تم استرجاع المجموعات من نسخه بيست')
else
...
os.execute('wget https://raw.githubusercontent.com/AhmedElsayed111/BOBXV/main/best.lua?token=GHSAT0AAAAAABRCLSCLMPQSGNPRGHRVNT4YYQDHHWQ')
...
local President = Redis:smembers(best.."TheBasics:Group"..v)
local Constructor = Redis:smembers(best.."Originators:Group"..v)
local Manager = Redis:smembers(best.."Managers:Group"..v)
local Admin = Redis:smembers(best.."Addictive:Group"..v)
local Vips = Redis:smembers(best.."Distinguished:Group"..v)
if k == 1 then
Get_Json = Get_Json..'"'..v..'":{'
else
Get_Json = Get_Json..',"'..v..'":{'
...
if (Redis:get(best..'Channel:Redis'..msg_chat_id..msg.sender.user_id) == 'true') then
if text == 'الغاء' or text == 'الغاء الامر •' then 
Redis:del(best..'Channel:Redis'..msg_chat_id..msg.sender.user_id)
...
local StatusMember = LuaTele.getChatMember(bana.id,best).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
return LuaTele.sendText(msg_chat_id,msg_id,"\n✘︙ البوت عضو في القناة يرجى رفع البوت ادمن واعادة وضع الاشتراك ","md",true)  
end
Redis:set(best..'Channel:Join',ChannelUser) 
...
Redis:set(best..'Channel:Redis'..msg_chat_id..msg.sender.user_id,true)
...
return LuaTele.sendText(msg_chat_id,msg_id,'✘︙ عدد الاعضاء قليل لا يمكن تفعيل المجموعه  يجب ان يكوم اكثر من :'..Redis:get(best..'Num:Add:Bot'),"md",true)  
end
...
Redis:set(best.."Status:Id"..msg_chat_id,true) ;Redis:set(best.."Status:Reply"..msg_chat_id,true) ;Redis:set(best.."Status:ReplySudo"..msg_chat_id,true) ;Redis:set(best.."Status:BanId"..msg_chat_id,true) ;Redis:set(best.."Status:SetId"..msg_chat_id,true) 
...
local list = Redis:smembers(best.."allM"..msg.chat_id)
for k,v in pairs(list) do
local Message = v
if Message then
...
local gmria = Redis:scard(best.."allM"..msg.chat_id)  
...
Redis:del(best.."Status:Del:Media"..msg.chat_id)
...
Redis:set(best.."Status:Del:Media"..msg.chat_id,true)
...
if not Redis:sismember(best.."HELPBEVQ:Groups",bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"✘︙ تم تنزيله مساعد مسبقا ").Reply,"md",true)  
else
Redis:del(best.."HELPBEVQ:Groups")
Redis:del(best.."HELPBEVQ:Groups", bana.id)
Redis:del(best.."id:HELPBEVQ:Groups", bana.id)
...
if not Redis:sismember(best.."Developers:Groups",bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"✘︙ تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(best.."Developers:Groups",bana.id) 
...
if not Redis:sismember(best.."TheBasicsQ:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"✘︙ تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(best.."TheBasicsQ:Group"..msg_chat_id,bana.id) 
...
if not Redis:sismember(best.."TheBasics:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"✘︙ تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(best.."TheBasics:Group"..msg_chat_id,bana.id) 
...
if not Redis:sismember(best.."Originators:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"✘︙ تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(best.."Originators:Group"..msg_chat_id,bana.id) 
...
if not Redis:sismember(best.."Managers:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"✘︙ تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(best.."Managers:Group"..msg_chat_id,bana.id) 
...
if not Redis:sismember(best.."Addictive:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"✘︙ تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(best.."Addictive:Group"..msg_chat_id,bana.id) 
...
if not Redis:sismember(best.."Distinguished:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"✘︙ تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(best.."Distinguished:Group"..msg_chat_id,bana.id) 
...
if not Redis:sismember(best.."DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(best.."DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(best.."HELPBEVQ:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"✘︙ تم تنزيله مساعد مسبقا ").Reply,"md",true)  
else
Redis:del(best.."HELPBEVQ:Groups")
Redis:del(best.."HELPBEVQ:Groups", Message_Reply.sender.user_id)
Redis:del(best.."id:HELPBEVQ:Groups", Message_Reply.sender.user_id)
...
if not Redis:sismember(best.."Developers:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"✘︙ تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(best.."Developers:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(best.."TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"✘︙ تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(best.."TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(best.."TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(best.."TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(best.."Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(best.."Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(best.."Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(best.."Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(best.."Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(best.."Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(best.."Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(best.."Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(best.."HELPBEVQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"✘︙ تم تنزيله مساعد مسبقا ").Reply,"md",true)  
else
Redis:del(best.."HELPBEVQ:Groups")
Redis:del(best.."HELPBEVQ:Groups", UserId)
Redis:del(best.."id:HELPBEVQ:Groups", UserId)
...
if not Redis:sismember(best.."Developers:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"✘︙ تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(best.."Developers:Groups",UserId) 
...
if not Redis:sismember(best.."TheBasicsQ:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"✘︙ تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(best.."TheBasicsQ:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(best.."TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"✘︙ تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(best.."TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(best.."Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"✘︙ تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(best.."Originators:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(best.."Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"✘︙ تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(best.."Managers:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(best.."Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"✘︙ تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(best.."Addictive:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(best.."Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"✘︙ تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(best.."Distinguished:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(best.."HELPBEVQ:Groups",bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"✘︙ تم ترقيته مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:del(best.."HELPBEVQ:Groups")
Redis:sadd(best.."HELPBEVQ:Groups", UserId)
Redis:set(best.."id:HELPBEVQ:Groups", UserId)
...
if Redis:sismember(best.."TheBasicsQ:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"✘︙ تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(best.."TheBasicsQ:Group"..msg_chat_id,bana.id) 
...
if Redis:sismember(best.."TheBasics:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"✘︙ تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(best.."TheBasics:Group"..msg_chat_id,bana.id) 
...
if Redis:sismember(best.."Originators:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"✘︙ تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(best.."Originators:Group"..msg_chat_id,bana.id) 
...
if Redis:sismember(best.."Managers:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"✘︙ تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(best.."Managers:Group"..msg_chat_id,bana.id) 
...
if not msg.Originators and not Redis:get(best.."Status:SetId"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"✘︙ تم تعطيل (الرفع) من قبل المنشئين","md",true)
end 
if Redis:sismember(best.."Addictive:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"✘︙ تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(best.."Addictive:Group"..msg_chat_id,bana.id) 
...
if Redis:sismember(best.."Distinguished:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"✘︙ تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(best.."Distinguished:Group"..msg_chat_id,bana.id) 
...
if Redis:sismember(best.."DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(best.."DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(best.."HELPBEVQ:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"✘︙ تم ترقيته مساعد مسبقا ").Reply,"md",true)  
else
Redis:del(best.."HELPBEVQ:Groups")
Redis:sadd(best.."HELPBEVQ:Groups", Message_Reply.sender.user_id)
Redis:set(best.."id:HELPBEVQ:Groups", Message_Reply.sender.user_id)
...
if Redis:sismember(best.."Developers:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"✘︙ تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(best.."Developers:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(best.."TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"✘︙ تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(best.."TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(best.."TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(best.."TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(best.."Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"✘︙ تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(best.."Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(best.."Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"✘︙ تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(best.."Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(best.."Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"✘︙ تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(best.."Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(best.."Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"✘︙ تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(best.."Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(best.."HELPBEVQ:Groups",UserId) then
...
if Redis:sismember(best.."TheBasicsQ:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"✘︙ تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(best.."TheBasicsQ:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(best.."TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"✘︙ تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(best.."TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(best.."Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"✘︙ تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(best.."Originators:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(best.."Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"✘︙ تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(best.."Managers:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(best.."Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"✘︙ تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(best.."Addictive:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(best.."Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"✘︙ تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(best.."Distinguished:Group"..msg_chat_id,UserId[2]) 
...
local Info_Members = Redis:smembers(best.."DevelopersQ:Groups") 
...
local Info_Members = Redis:smembers(best.."Developers:Groups") 
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"✘︙ لا يوجد مطورين حاليا , ","md",true)  
end
ListMembers = '\n*✘︙ قائمه مطورين البوت \n ———————×———————*\n'
...
local Info_Members = Redis:smembers(best.."TheBasicsQ:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(best.."TheBasics:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(best.."Originators:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(best.."Managers:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(best.."Addictive:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(best.."Distinguished:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
if not msg.Originators and not Redis:get(best.."Status:BanId"..msg_chat_id) then
...
if Redis:sismember(best.."BanGroup:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"✘︙ تم حظره من الجروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(best.."BanGroup:Group"..msg_chat_id,bana.id) 
LuaTele.setChatMemberStatus(msg.chat_id,bana.id,'banned',0)
...
if not Redis:sismember(best.."BanGroup:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"✘︙ تم الغاء حظره من الجروب مسبقا ").Reply,"md",true)  
else
Redis:srem(best.."BanGroup:Group"..msg_chat_id,bana.id) 
LuaTele.setChatMemberStatus(msg.chat_id,bana.id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(best.."SilentGroup:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"✘︙ تم كتمه في الجروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(best.."SilentGroup:Group"..msg_chat_id,bana.id) 
...
if not Redis:sismember(best.."SilentGroup:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"✘︙ تم الغاء كتمه من الجروب ").Reply,"md",true)  
else
Redis:srem(best.."SilentGroup:Group"..msg_chat_id,bana.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"✘︙ تم الغاء كتمه من الجروب ").Reply,"md",true)  
end
end
...
Rink = 1
elseif Redis:sismember(best.."DevelopersQ:Groups",msg.sender.user_id)  then
Rink = 2
elseif Redis:sismember(best.."Developers:Groups",msg.sender.user_id)  then
Rink = 3
elseif Redis:sismember(best.."TheBasicsQ:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 4
elseif Redis:sismember(best.."TheBasics:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 5
elseif Redis:sismember(best.."Originators:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 6
elseif Redis:sismember(best.."Managers:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 7
elseif Redis:sismember(best.."Addictive:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 8
elseif Redis:sismember(best.."Distinguished:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 9
else
Rink = 10
end
...
Redis:srem(best.."Addictive:Group"..msg_chat_id, msg.sender.user_id)
Redis:srem(best.."Distinguished:Group"..msg_chat_id, msg.sender.user_id)
...
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(best.."TheBasics:Group"..msg_chat_id,v.member_id.user_id) 
x = x + 1
else
Redis:sadd(best.."Addictive:Group"..msg_chat_id,v.member_id.user_id) 
y = y + 1
end
end
end
...
if text == 'مبرمج السورس ' or text == '' or text == '' then  
...
if photo.total_count > 0 then
local TestText = "  ‹[ best  Source ]›\n— — — — — — — — —\n ✘︙*Dev Name* :  [".. ban.first_name.."](tg://user?id="..UserId_Info.id..")\n✘︙ *Dev Bio* : [‹[ "..Bio.." ]›]"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = '< 𝙒𝙀𝙇𝘾𝙊𝙈𝙀 𝘽𝙍𝙊  >', url = "https://t.me/QQWGT"}
},
}
local msg_id = msg.id/2097152/0.5 
 https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id='..msg.chat_id..'&caption='..URL.escape(TestText)..'&photo='..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id..'&reply_to_message_id='..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboardd))
...
if text == 'المطور السورس' or text == '' or text == '' then  
local UserId_Info = LuaTele.searchPublicChat("QQWGT")
if UserId_Info.id then
local  ban = LuaTele.getUser(UserId_Info.id)
local  bain = LuaTele.getUserFullInfo(Sudo_Id)
...
keyboardd.inline_keyboard = {
{
{text = '< Developers best  >', url = "https://t.me/QQWGT"}
},
}
local msg_id = msg.id/2097152/0.5 
 https.request("https://api.telegram.org/bot"..Token..'/sendMessage?chat_id=' .. msg.chat_id .. '&text=' .. URL.escape(TestText).."&reply_to_message_id="..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboardd))
...
if text == 'المبرمج بوب' or text == 'بوب' or text == 'احمد' then  
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
local bains = LuaTele.getUser(msg.sender.user_id)
if bains.first_name then
...
LuaTele.sendText(2069112486,0,'*\n✘︙ مرحباً عزيزي المبرمج بوب \nشخص ما يحتاج الي مساعده\n———————×———————\n✘︙ اسمه :- '..klajq..' \n✘︙ ايديه :-  : '..msg.sender.user_id..'\n✘︙ - معرفة '..basgk..' \n*',"md",false, false, false, false, reply_markup)
end
if text == 'المساعد' or text == 'مساعد' then   
local id = Redis:get(best.."id:HELPBEVQ:Groups")
...
local Added_Me = Redis:get(best.."Who:Added:Me"..msg.sender.user_id..':'..msg.sender.user_id)
if Added_Me then 
...
local list = Redis:smembers(best.."cleaner"..msg_chat_id)
if #list == 0 then 
...
Redis:del(best.."cleaner"..msg_chat_id)
...
if Redis:get(best.."Status:gamle"..msg.chat_id) then
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
...
Redis:set(best..'lock:Cht'..msg.chat_id,true) 
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"✘︙ تم قفـل السب").Lock,"md",true)  
end
...
Redis:del(best..'lock:Cht'..msg.chat_id) 
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"✘︙ تم فتح السب").unLock,"md",true)  
end
...
if Redis:get(best.."Status:Reply"..msg.chat_id) then
StatusReply = '❬ ✓ ❭' else StatusReply = '❬ ✗ ❭'
end
if Redis:get(best.."Status:ReplySudo"..msg.chat_id) then
...
Rink = 1
elseif Redis:sismember(best.."DevelopersQ:Groups",Message_Reply.sender.user_id)  then
Rink = 2
elseif Redis:sismember(best.."Developers:Groups",Message_Reply.sender.user_id)  then
Rink = 3
elseif Redis:sismember(best.."TheBasicsQ:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 4
elseif Redis:sismember(best.."TheBasics:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 5
elseif Redis:sismember(best.."Originators:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 6
elseif Redis:sismember(best.."Managers:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 7
elseif Redis:sismember(best.."Addictive:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 8
elseif Redis:sismember(best.."Distinguished:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 9
else
Rink = 10
end
...
Rink = 1
elseif Redis:sismember(best.."DevelopersQ:Groups",bana.id)  then
Rink = 2
elseif Redis:sismember(best.."Developers:Groups",bana.id)  then
Rink = 3
elseif Redis:sismember(best.."TheBasicsQ:Group"..msg_chat_id, bana.id) then
Rink = 4
elseif Redis:sismember(best.."TheBasics:Group"..msg_chat_id, bana.id) then
Rink = 5
elseif Redis:sismember(best.."Originators:Group"..msg_chat_id, bana.id) then
Rink = 6
elseif Redis:sismember(best.."Managers:Group"..msg_chat_id, bana.id) then
Rink = 7
elseif Redis:sismember(best.."Addictive:Group"..msg_chat_id, bana.id) then
Rink = 8
elseif Redis:sismember(best.."Distinguished:Group"..msg_chat_id, bana.id) then
Rink = 9
else
Rink = 10
end
...
Redis:del(best.."DevelopersQ:Groups") 
...
Redis:del(best.."Developers:Groups") 
...
Redis:del(best.."TheBasics:Group"..msg_chat_id) 
...
Redis:del(best.."Originators:Group"..msg_chat_id) 
...
Redis:del(best.."Managers:Group"..msg_chat_id) 
...
Redis:del(best.."Addictive:Group"..msg_chat_id) 
...
Redis:del(best.."Distinguished:Group"..msg_chat_id) 
...
Redis:set(best..'GetTexting:best'..msg_chat_id..':'..msg.sender.user_id,true)
...
{{text = 'Delete Instagram',url="https://www.instagram.com/accounts/login/?next=/accounts/remove/request/permanent/"},{text = 'Delete Snapchat',url="https://accounts.snapchat.com/accounts/login?continue=https%3A%2F%2Faccounts.snapchat.com%2Faccounts%2Fdeleteaccount"}},{{text= '-  𝑺𝑶𝑼𝑹𝑪𝑬 𝑩𝑬𝑺𝑻 .',url="https://t.me/QQWGT2"}}
}
local msg_id = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id=' .. msg.chat_id .. '&photo=https://t.me/QQWGT2/2560&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
Redis:incrby(best.."Num:Add:Games"..msg.chat_id..Message_Reply.sender.user_id, text:match("^اضف مجوهرات (%d+)$"))  
...
local ban = LuaTele.getUser(best)
local bain = LuaTele.getUser(msg.sender.user_id)
...
local CmdStart = '*\n✘︙ أهلآ بك في بوت '..(Redis:get(best.."Name:Bot") or "بيست")..
...
{
{text = '- المطور .', url = "https://t.me/"..ban.username..""},{text = '- لتنصيب بوتك .', url = 't.me/QQWGT'},
},
{
{text = '➕ اضف البوت لمجموعتك', url = 't.me/'..UserBot..'?startgroup=new'}, 
},
...
local TextHelp = [[*
• أهلا بك في قائمة العاب سورس بيست اختر نوع الالعاب 
*]]
LuaTele.editMessageText(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
...
local TextHelp = [[*
• مرحبا بك في الالعاب المتطورة الخاص بسورس بيست 
...
Redis:set(best.."rank_tf"..IdUser,"rank_tk") 
end
end 
...
Redis:set(best.."AddSudosNew"..ChatId,true)
end
end
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(best.."AddSudosNew"..ChatId)
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(best.."rb:bna"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➣ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if Info_Members.members[k].bot_info == nil then
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(best.."TheBasics:Group"..UserId[2],v.member_id.user_id) 
x = x + 1
else
Redis:sadd(best.."Addictive:Group"..UserId[2],v.member_id.user_id) 
y = y + 1
end
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:del(best.."Lock:tagservrbot"..UserId[2],true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:del(best..''..lock..UserId[2],"del")    
end
LuaTele.answerCallbackQuery(data.id, "✘︙ تم قفل جميع الاوامر بنجاح  ", true)
end
end
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(best.."TheBasics:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(best.."TheBasicsQ:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(best.."Originators:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(best.."Managers:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(best.."Addictive:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(best.."Distinguished:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➣ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
--   This Is The Source Channel @QQWGT2 .   --
--                - 𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐋𝐀𝐂𝐊 -                 --
--        -- https://t.me/QQWGT2 --         --
------------------------------------------------ 
