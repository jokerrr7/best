...
if Redis:get(best.."best:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n ᥀︙تم الغاء امر تعين الايدي عام","md",true)  
Redis:del(best.."best:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(best.."best:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(best.."best:Set:Id:Groups",text:match("(.*)"))
LuaTele.sendText(msg_chat_id,msg_id,' ᥀︙تم تعين الايدي عام',"md",true)  
end
if Redis:get(best.."best:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n ᥀︙تم الغاء امر تعين الايدي","md",true)  
Redis:del(best.."best:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(best.."best:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(best.."best:Set:Id:Group"..msg.chat_id,text:match("(.*)"))
...
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/'..Redis:get(best..'best:Channel:Join')}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n᥀︙عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
end 
...
Get_Is_Id = Redis:get(best.."best:Set:Id:Group"..msg_chat_id)
...
local TotalMsg = Redis:get(best..'best:Num:Message:User'..msg_chat_id..':'..Message_Reply.sender.user_id) or 0
local TotalEdit = Redis:get(best..'best:Num:Message:Edit'..msg_chat_id..Message_Reply.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
return LuaTele.sendText(msg_chat_id,msg_id,
'\n*᥀︙ايديه : '..UserId..
...
local TotalMsg = Redis:get(best..'best:Num:Message:User'..msg_chat_id..':'..UserId_Info.id) or 0
local TotalEdit = Redis:get(best..'best:Num:Message:Edit'..msg_chat_id..UserId_Info.id) or 0
local TotalMsgT = Total_message(TotalMsg) 
return LuaTele.sendText(msg_chat_id,msg_id,
'\n*᥀︙ايديه : '..UserId..
'\n᥀︙معرفه : @'..UserName..
...
Redis:set(best.."best:Set:Id:Group"..msg.chat_id,Text_Rand)
...
Redis:set(best.."best:Sasa:Jeka"..msg_chat_id,true) 
...
if TextMsg == 'ردود السورس' then
Redis:del(best.."best:Sasa:Jeka"..msg_chat_id) 
...
Redis:setex(best.."best:Set:Id:Groups"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
᥀︙ ارسل الان النص
᥀︙ يمكنك اضافه :
...
if not Redis:get(best.."best:Sasa:Jeka"..msg_chat_id) then
